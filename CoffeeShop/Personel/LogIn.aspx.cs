...
namespace CoffeeShop.Personel
{
    public partial class LogIn : System.Web.UI.Page
    {
        ...
        protected void btnLogIn_Click(object sender, EventArgs e)
        {
            ...
            {
                Classes.Personel LoginPersonel = xt.Personels.Where(u => u.UserName == txtUserName.Text || u.Password == txtPassword.Text).FirstOrDefault();
                if (LoginPersonel != null)
                {
                    Session.Add("PersonelId", LoginPersonel.Id);
